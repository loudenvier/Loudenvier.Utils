...
namespace System {
    ...
    /// <summary>
    /// The <c>BitConverterLittleEndian</c> class replicates the API surface of
    ...
    /// for converting base data types into arrays are in little-endian byte-order,
    ...
    /// when converting from/to little-endian. 
    /// It removes ambiguity when reading from sources or writing to destinations in 
    /// little-endian byte-order (file formats, exchange protocols). 
    ...
    /// when dealing with little-endian data.
    /// </remarks>
    public static class BitConverterLittleEndian
    {
        ...
        /// <summary>
        /// Returns the specified Unicode character value as an array of bytes in little-endian byte-order.
        /// </summary>
        /// <param name="value">The character to convert.</param>
        /// <remarks>Differently from <see cref="BitConverter.GetBytes(char)"/> the order of bytes in 
        /// the array returned by the <c>GetBytes</c> method will always be in little-endian byte-order 
        ...
        /// in little-endian byte-order.</summary>
        ...
        /// bytes in the array is always assumed to be in little-endian byte-order regardless 
        ...
        /// specified position in a byte array stored in little-endian byte-order.
        /// </summary>
        /// <param name="value">An array of bytes that includes the four bytes to convert.</param>
        /// <param name="startIndex">The starting position within <paramref name="value"/>.</param>
